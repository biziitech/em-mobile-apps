...
public class FieldVisitInputUI extends AppCompatActivity {
    private Uri fileUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_field_visit_input_ui);
        ...
        btnCaptureImg = (Button) findViewById(R.id.cpic);
